...
public class GuiChat extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_146415_a.setEnableBackgroundDrawing(false);
        this.field_146415_a.setFocused(true);
        this.field_146415_a.setText(this.field_146409_v);
        this.field_146415_a.setCanLoseFocus(false);
    }
        ...
        if (par3 == 0 && this.mc.gameSettings.chatLinks)
        {
            ...
            if (var4 != null)
            {
                ...
                if (var5 != null)
                {
                    if (isShiftKeyDown())
                    {
                        this.field_146415_a.writeText(var4.getUnformattedTextForChat());
                    }
                    else
                    {
                        URI var6;
    ...
    public void func_146404_p_()
    {
        ...
        {
            this.field_146415_a.deleteFromCursor(this.field_146415_a.func_146197_a(-1, this.field_146415_a.getCursorPosition(), false) - this.field_146415_a.getCursorPosition());
        ...
        {
            int var1 = this.field_146415_a.func_146197_a(-1, this.field_146415_a.getCursorPosition(), false);
            this.field_146412_t.clear();
            this.field_146413_s = 0;
            String var2 = this.field_146415_a.getText().substring(var1).toLowerCase();
            var3 = this.field_146415_a.getText().substring(0, this.field_146415_a.getCursorPosition());
            ...
            this.field_146415_a.deleteFromCursor(var1 - this.field_146415_a.getCursorPosition());
        }
        ...
        this.field_146415_a.writeText((String)this.field_146412_t.get(this.field_146413_s++));
    }
