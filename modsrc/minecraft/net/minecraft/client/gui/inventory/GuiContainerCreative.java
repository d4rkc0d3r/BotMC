...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            this.field_147062_A.setEnableBackgroundDrawing(false);
            this.field_147062_A.setVisible(false);
            this.field_147062_A.setTextColor(16777215);
    ...
    private void func_147050_b(CreativeTabs p_147050_1_)
    {
        ...
        if (this.field_147062_A != null)
        {
            if (p_147050_1_ == CreativeTabs.tabAllSearch)
            {
                ...
                this.field_147062_A.setCanLoseFocus(false);
            ...
            {
                this.field_147062_A.setVisible(false);
                this.field_147062_A.setCanLoseFocus(true);
